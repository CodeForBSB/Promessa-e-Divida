...
//     *************************************************************/
    const locations = [
      { title: '"Implantação de 15 Km de pista de ciclismo/caminhada na Orla do Lago"', latitude: -15.781818, longitude: -47.821486 },
      { title: '"Contratação e início das obras da Concha Acústica - 2a etapa"', latitude: -15.786876, longitude: -47.837105 },
      { title: '"Conclusão do Calçadão da Ponte das Garças', latitude: -15.839935, longitude: -47.898191 }
    ]
//     /* ***********************************************************
//     * STEP 2
...
//     *************************************************************/
    ...
    return (
      <MapView.Marker key={location.title}
